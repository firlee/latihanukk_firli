<div class="card">
    ...
    <div class="card-body">
        ...
        <input type = "hidden" name="id_catatan" value="<?=$fragment['0']; ?>">
            ...
            <div class="form-group">
                <label>harga</label>
                <input value="<?=$fragment['5']; ?>" name="harga" type="text" required class=form-control placeholder="Masukkan harga">
            </div>
            <div class="form-group">
                <label>nama_barang</label>
                <input value="<?=$fragment['6']; ?>" name="nama_barang" type="text" required class=form-control placeholder="nama_barang harga">
            </div>
